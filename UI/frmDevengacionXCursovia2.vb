Public Class frmDevengacionXCursovia2
    ...
    Private Sub btnDevengar_Click(sender As Object, e As EventArgs) Handles btnDevengar.Click
        ...
        alumnos = repoAlu.Traer_X_Sala(cbxCurso.SelectedValue, cbxTurno.Text, False)

        monto = repoDeveng.montoServicio(cbxServicio.SelectedValue, False)
        ...
        For Each alu In alumnos
            ...
            devengacion = repoDeveng.Devengar_sala(alu, txt_observaciones.Text, cbxCuenta.Text, cbxServicio.Text, monto2, False)
            nroDev = devengacion.ToString
            nroDev = nroDev.PadLeft(8, "0")

            Dim objrep = Nothing
            If cbxVencimiento.SelectedIndex + 1 = 1 Then
                objrep = New rptDevengacionvia2
            ElseIf cbxVencimiento.SelectedIndex + 1 = 2 Then
                objrep = New rptDevengacionvia22v
            ElseIf cbxVencimiento.SelectedIndex + 1 = 3 Then
                objrep = New rptDevengacionvia21v
            ElseIf cbxVencimiento.SelectedIndex + 1 = 4 Then
                objrep = New rptDevengacionvia2sv
            Else
                objrep = New rptDevengacionvia2
            End If
            ...
            Try
                ...
                objrep.SetParameterValue(4, alumno.descuento.ToString)
