Public Class frmDatosNegociovia2
    ...
    Private Sub cmdGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGrabar.Click
        If Validar() Then
            ...
            If editar Then
                repo.Editar(datosNeg, False)
            Else
                repo.agregar(datosNeg, False)
            End If
    ...
    Private Sub btnBuscaProv_Click(sender As Object, e As EventArgs) Handles btnBuscaProv.Click
        ...
        If txtRazonSocial.Text <> "" Then
            ...
            id = 0
            FormatoBusqueda("datosnegocio", CuerpoSelect, "razon_social", Trim(txtRazonSocial.Text), False, "id", "razon_social", id)
            frmBusqueda.ShowDialog()
            proveedor_id = frmBusqueda.Codigo
            proveedor = frmBusqueda.Nombre
            frmBusqueda.Dispose()
            If proveedor_id <> 0 Then
                repoDatosNeg.Traer(proveedor_id, datosNeg, False)
                acomodoProveedor()
