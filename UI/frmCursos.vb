Public Class frmCursos
    ...
    Private Function Validar() As Boolean
        ...
        Else
            If Not Editar Then
                Dim repo = New RepoCurso
                If repo.Existe(Trim(txtNombre.Text)) Then
                    ColorearValidacion(True, lblNombre)
    ...
    Private Sub cmdBuscaNombre_Click(sender As Object, e As EventArgs) Handles cmdBuscaNombre.Click
        If txtNombre.Text <> "" Then
            ...
            FormatoBusqueda("cursos", CuerpoSelect, "cur_nombre", Trim(txtNombre.Text), True, "cur_id", "cur_nombre", Cur.id)
            ...
            If Cur.id <> 0 Then
                ...
                If repo.Traer_X_id(Cur.id, Cur) Then
                    AcomodoCurso()
