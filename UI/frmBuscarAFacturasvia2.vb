Public Class frmBuscarAFacturasvia2
    ...
    Private Sub btn_Alumno_Click(sender As Object, e As EventArgs) Handles btn_Alumno.Click
        ...
        If txt_NombreAlumno.Text <> "" Then
            ...
            FormatoBusqueda("alumnos, personas", CuerpoSelect, "alumnos.per_id = personas.per_id AND per_apellido", Trim(txt_NombreAlumno.Text), False, "per_id", "nombre", res)
