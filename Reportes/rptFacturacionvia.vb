...
Public Class rptFacturacionvia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFacturacionvia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturacionvia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturacionvia = New rptFacturacionvia()
        rpt.Site = Me.Site
        Return rpt
    End Function
