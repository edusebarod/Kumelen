...
Public Class rptAlumnosXNivel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptAlumnosXNivel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlumnosXNivel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlumnosXNivel = New rptAlumnosXNivel()
        rpt.Site = Me.Site
        Return rpt
    End Function
