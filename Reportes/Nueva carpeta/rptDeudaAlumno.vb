...
Public Class rptDeudaAlumno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptDeudaAlumno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeudaAlumno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeudaAlumno = New rptDeudaAlumno()
        rpt.Site = Me.Site
        Return rpt
    End Function
