...
Public Class rptFacturacionvia1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFacturacionvia1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturacionvia1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturacionvia1 = New rptFacturacionvia1()
        rpt.Site = Me.Site
        Return rpt
    End Function
