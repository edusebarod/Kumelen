...
Public Class rptMovimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMovimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovimientos = New rptMovimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
