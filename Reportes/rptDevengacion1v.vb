...
Public Class rptDevengacion1v
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptDevengacion1v.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDevengacion1v
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDevengacion1v = New rptDevengacion1v()
        rpt.Site = Me.Site
        Return rpt
    End Function
