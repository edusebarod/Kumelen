...
Public Class rptFallodeCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFallodeCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFallodeCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFallodeCaja = New rptFallodeCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
