...
Public Class rptCompromiso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptCompromiso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompromiso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompromiso = New rptCompromiso()
        rpt.Site = Me.Site
        Return rpt
    End Function
