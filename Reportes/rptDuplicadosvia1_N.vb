...
Public Class rptDuplicadosvia1_N
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDuplicadosvia1_N.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptDuplicadosvia1_N.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDuplicadosvia1_N
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDuplicadosvia1_N = New rptDuplicadosvia1_N()
        rpt.Site = Me.Site
        Return rpt
    End Function
