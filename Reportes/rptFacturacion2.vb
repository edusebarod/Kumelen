...
Public Class rptFacturacion2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFacturacion2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturacion2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturacion2 = New rptFacturacion2()
        rpt.Site = Me.Site
        Return rpt
    End Function
