...
Public Class rptAlumnoMaternal2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptAlumnoMaternal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlumnoMaternal2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlumnoMaternal2 = New rptAlumnoMaternal2()
        rpt.Site = Me.Site
        Return rpt
    End Function
