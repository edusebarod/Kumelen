...
Public Class rptAlumnoInicial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptAlumnoInicial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlumnoInicial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlumnoInicial = New rptAlumnoInicial()
        rpt.Site = Me.Site
        Return rpt
    End Function
