...
Public Class rptFacturacion1_N
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFacturacion1_N.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturacion1_N
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturacion1_N = New rptFacturacion1_N()
        rpt.Site = Me.Site
        Return rpt
    End Function
