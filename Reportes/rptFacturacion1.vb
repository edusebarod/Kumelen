...
Public Class rptFacturacion1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFacturacion1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturacion1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturacion1 = New rptFacturacion1()
        rpt.Site = Me.Site
        Return rpt
    End Function
