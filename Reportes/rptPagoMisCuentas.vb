...
Public Class rptPagoMisCuentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptPagoMisCuentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagoMisCuentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagoMisCuentas = New rptPagoMisCuentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
