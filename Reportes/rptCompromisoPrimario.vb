...
Public Class rptCompromisoPrimario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCompromisoPrimario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptCompromisoPrimario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompromisoPrimario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompromisoPrimario = New rptCompromisoPrimario()
        rpt.Site = Me.Site
        Return rpt
    End Function
