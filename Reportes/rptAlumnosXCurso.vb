...
Public Class rptAlumnosXCurso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptAlumnosXCurso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlumnosXCurso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlumnosXCurso = New rptAlumnosXCurso()
        rpt.Site = Me.Site
        Return rpt
    End Function
