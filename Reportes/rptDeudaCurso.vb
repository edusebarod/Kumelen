...
Public Class rptDeudaCurso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptDeudaCurso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeudaCurso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeudaCurso = New rptDeudaCurso()
        rpt.Site = Me.Site
        Return rpt
    End Function
