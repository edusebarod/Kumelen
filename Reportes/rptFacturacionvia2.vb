...
Public Class rptFacturacionvia2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptFacturacionvia2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturacionvia2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturacionvia2 = New rptFacturacionvia2()
        rpt.Site = Me.Site
        Return rpt
    End Function
