...
Public Class rptDuplicadosvia2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptDuplicadosvia2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDuplicadosvia2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDuplicadosvia2 = New rptDuplicadosvia2()
        rpt.Site = Me.Site
        Return rpt
    End Function
