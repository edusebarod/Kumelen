...
Public Class rptDuplicadosvia1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kumelen.rptDuplicadosvia1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDuplicadosvia1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDuplicadosvia1 = New rptDuplicadosvia1()
        rpt.Site = Me.Site
        Return rpt
    End Function
